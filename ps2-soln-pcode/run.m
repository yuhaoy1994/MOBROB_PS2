...
% set to 1 to display time evolution of correlation coefficients while
% simulation is running
Param.plotCorrelations = 0;

% set to 1 to display time evolution of determinant of landmark matrix
% subblock
Param.plotDeterminant = 0;

% set to 1 to generate map.avi, cor.avi, det.avi
Param.makeMovie = 0;
